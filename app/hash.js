...
module.exports = function(password, salt) {
    return new Promise(async (resolve, reject) => {
        try {// si le salt n'est pas existant alors ca va nous faire un salt ici c'est pour la creation d'un user sont salt sera creer automatiquement sinon pour le login ca va récupérer le salt et le password
            if (!salt)
